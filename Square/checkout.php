...
try {
  ...
  $money_A->setAmount($_POST['amount']*100);

  $item_A = new OrderLineItem($_POST['quantity']);
  $item_A->setName($_POST['item_name']);
  ...
  $checkout_request->setRedirectUrl('http://localhost/Secure_E-Commerce_A2/Square/confirmation.php');
